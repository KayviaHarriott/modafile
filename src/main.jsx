...
function DropPanel({ folder, incomingFile, visible }) {
  ...
  const compress = async () => {
    ...
    try {
      const rawFile = file.path ? await invoke('read_file', { path: file.path }) : await file.arrayBuffer()
